...
module gemv_q8_0_stream_core #(
    ...
    localparam [4:0] ST_SCALE_LOAD  = 5'd9;
    localparam [4:0] ST_SCALE_MUL   = 5'd10;
    localparam [4:0] ST_SCALE_SHIFT = 5'd11;
    localparam [4:0] ST_SCALE_ACCUM = 5'd12;
    localparam [4:0] ST_INPUT_WAIT2 = 5'd13;
    localparam [4:0] ST_INPUT_WAIT3 = 5'd14;
    localparam [4:0] ST_INPUT_CAPTURE = 5'd15;
    localparam [4:0] ST_SCALE_SAT   = 5'd16;
