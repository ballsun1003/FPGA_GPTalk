...
- 현재 단계: S05.3 PASS 완료. S05.2 RTL performance counter bitstream은 mode=0 board regression FAIL로 폐기했고, rejected 산출물은 사용 금지다. Active known-good bit/XSA alias를 재export했고 PC에서 SD에 구운 BOOT.BIN으로 cold-boot 후 S05를 재검증했다. S05.3에서 mode=1 `333 ms` 지연은 FPGA/DMA가 아니라 verbose debug/status register read 및 serial logging artifact로 판정했다. quiet hot path 100회 반복에서 mode=0/mode=1 모두 PASS, 평균 약 244/241 us. 다음 단계는 S06 runtime 연결이다.
...
S05는 PC-staged SD BOOT.BIN으로 cold-boot 후 보드 재검증까지 PASS했다. S05.3 latency forensic도 PASS했다. SD bootfs `uEnv.txt`의 `mem=960M` carveout은 유지되어야 한다. PetaLinux full rebuild 대상 문제가 아니다. 다음 실작업은 S06 runtime 연결이며, hot path에서는 full debug register scan/verbose serial logging을 켜지 않는다.

최근 관측 SD 상태:

- 최근 PC SD staging device: `/dev/sda1` bootfs
- staging 후 bootfs는 unmount 완료
- SD 작업 전에는 반드시 `lsblk`로 장치명을 재확인한다
- 현재 SD bootfs active `BOOT.BIN`: `artifacts/boot_tests/test_s05_3_reexport_xsa_s03_fsbl_active_bit_s03_uboot/BOOT.BIN`
- 현재 SD bootfs `BOOT.BIN` hash: `17a771c5cc304143a07f4444b7baf87a44fb2609f66b9ed42b4cde3757836a42`
- PC SD staging log: `logs/test_s05_3_reexport_xsa_s03_fsbl_active_bit_s03_uboot_sd_stage_pc.log`
- SD bootfs backup made before this staging: `/BOOT_BEFORE_TEST_S05_3_REEXPORT_XSA_S03_FSBL_ACTIVE_BIT_S03_UBOOT_20260701_010620.BIN`
- cold-boot validation log: `logs/s05_3_reexport_xsa_cold_boot_pass_20260701_010926.txt`
...
- GPTalk DMA 74 MHz aliases: `hw/vivado_project/export/GPTalk_dma_74MHz.bit`, `hw/vivado_project/export/GPTalk_dma_74MHz.xsa`
- 현재 active bitstream hash: `158ba9de633fc8ea4a8b4822d0589fad427ec25502ff67cc8d44ef604696acb0`
- 현재 active XSA hash: `f6ef5281f7558d21435127cc6858e72d312089e1f7a26bed34ce4206ae9a1d7d`
- 현재 GEMV OOC DCP hash: `6826ab2bbeb37ef5548abd64e3214e382683e82b3838f0b96189ef1f361ae5e6`
- 현재 known-good BOOT hash: `17a771c5cc304143a07f4444b7baf87a44fb2609f66b9ed42b4cde3757836a42`
- cold-boot S05 validation log: `logs/s05_3_reexport_xsa_cold_boot_pass_20260701_010926.txt`
- S05.3 latency forensic doc: `docs/s05_3_control_polling_dma_latency.md`
- S05.3 repeated benchmark: `logs/s05_3_repeated_benchmark.txt`
- final known-good backup: `artifacts/s05_3_validated_known_good_reexport_20260701_010926`
- rejected S05.2 counter XSA는 `hw/vivado_project/export/GPTalk_dma_s05_2_failed_counter_DO_NOT_USE.xsa`와 `hw/vivado_project/export/GPTalk_dma_74MHz_s05_2_failed_counter_DO_NOT_USE.xsa`로 격리함
